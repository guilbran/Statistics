...
########     Gabarito exercícios aula 1      ##########
########                                     ##########
#######################################################

# Suponha que você foi contratado para prestar consultoria a um produtor de frangos que deseja conhecer
# a melhor dieta para engordar os seus animais.
# Para ter uma ideia do problema, atualmente com melhora genética o abate costuma ocorrer entre 28 e 42 dias,
# quando o peso vivo do animal for de aproximadamente 1 kg. Utilizaremos uma base disponível no R
# que contém dados relativos a nutrição desses animais.
